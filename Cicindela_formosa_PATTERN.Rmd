...
Converteach recolorize fit in back to a patternize format using recolorize_to_patternize() so that we can continue analyses in patternize (Does recolorize offer colour pattern analuses tools? at all?)
```{r}
